...
typedef enum
{
    EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_SET = 0xE1,
    EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_GET = 0xE2,
    EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_SET_UNRELIABLE = 0xE3,
    EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_STATUS = 0xE4

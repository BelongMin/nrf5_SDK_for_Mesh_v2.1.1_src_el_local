/**************************************************************************
  * @file       : el_simple_color_temperature_server.c
...
static void reply_status(const el_simple_color_temperature_server_t *p_server, const access_message_rx_t *p_message, uint8_t color_temperature)
{
    el_simple_color_temperature_msg_status_t status;
    status.present_color_temperature = color_temperature;
    access_message_tx_t reply;
    reply.opcode.opcode = EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_STATUS;
    reply.opcode.company_id = EL_SIMPLE_COLOR_TEMPERATURE_COMPANY_ID;
...
{
    el_simple_color_temperature_server_t *p_server = p_args;
    NRF_MESH_ASSERT(p_server->set_cb != NULL);

    uint8_t value = ((el_simple_color_temperature_msg_set_t *)p_message->p_data)->color_temperature;
    value = p_server->set_cb(p_server, value);
    reply_status(p_server, p_message, value);
    (void)el_simple_color_temperature_server_status_publish(p_server, value);
}
...
{
    el_simple_color_temperature_server_t * p_server = p_args;
    uint8_t value = ((el_simple_color_temperature_msg_set_unreliable_t*)p_message->p_data)->color_temperature;
    value = p_server->set_cb(p_server, value);
    (void)el_simple_color_temperature_server_status_publish(p_server, value);
}
...
{
    {ACCESS_OPCODE_VENDOR(EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_SET,              EL_SIMPLE_COLOR_TEMPERATURE_COMPANY_ID), handle_set_cb},
    {ACCESS_OPCODE_VENDOR(EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_GET,              EL_SIMPLE_COLOR_TEMPERATURE_COMPANY_ID), handle_get_cb},
    {ACCESS_OPCODE_VENDOR(EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_SET_UNRELIABLE,   EL_SIMPLE_COLOR_TEMPERATURE_COMPANY_ID), handle_set_unreliable_cb}
};
...
uint32_t el_simple_color_temperature_server_init(el_simple_color_temperature_server_t * p_server, uint16_t element_index)
{
    ...
    init_params.model_id.model_id = EL_SIMPLE_COLOR_TEMPERATURE_SERVER_MODLE_ID;
...
{
    el_simple_color_temperature_msg_status_t status;
    status.present_color_temperature = value;
    access_message_tx_t msg;
    msg.opcode.opcode = EL_SIMPLE_COLOR_TEMPERATURE_OPCODE_STATUS;
    msg.opcode.company_id = EL_SIMPLE_COLOR_TEMPERATURE_COMPANY_ID;
